...
(def translations
  {:ru
   {:app-name "Маячок"
    ...
    :heatmap-title "Карта потребностей"
   ...
   {:app-name "Mayachok"
    ...
    :survey-title "Anonyme Umfrage"
    :survey-hint "Helfen Sie uns, Mütter besser zu verstehen."
    :survey-age "Ihre Altersgruppe"
    :survey-birth "Zeit seit der Geburt"
    :survey-first "Erstes Kind?"
    :survey-skip "Möchte ich nicht angeben"
    :survey-yes "Ja, erstes Kind"
    :survey-no "Nein, ich habe andere Kinder"
    :survey-submit "Absenden"
    :survey-birth-0-6w "0-6 Wochen"
    :survey-birth-6w-3m "6 Wochen - 3 Monate"
    :survey-birth-3-6m "3-6 Monate"
    :survey-birth-6m+ "6+ Monate"
    :open-source "Dies ist ein Open-Source-Projekt."
   ...
   :uk
   {:app-name "Маячок"
    :app-title "Маячок — Единбурзька шкала післяпологової депресії"
    :nav-home "Головна"
    :nav-map "Карта"
    :tagline "Коротке опитування про ваше самопочуття після пологів"
    :description "Це стандартна анкета (Единбурзька шкала післяпологової депресії), яку використовують лікарі по всьому світу. Вона допомагає зрозуміти, чи потрібна вам додаткова підтримка."

...
(def translations
  {:ru
   {:app-name "Маячок"
    ...
    :region-question "Где вы находитесь?"
    :region-title "Помогите нам понять, где мамам нужна поддержка"
    :region-hint "Ваш регион будет сохранён анонимно. Это поможет направить ресурсы туда, где они нужны больше всего."
    :region-select-country "Выберите страну"
    :region-select-region "Выберите регион"
    :region-submit "Отправить"
    :region-skip "Пропустить"}
   ...
   {:app-name "Mayachok"
    ...
    :region-question "Where are you located?"
    :region-title "Help us understand where mothers need support"
    :region-hint "Your region will be stored anonymously. This helps direct resources where they are needed most."
    :region-select-country "Select country"
    :region-select-region "Select region"
    :region-submit "Submit"
    :region-skip "Skip"
   ...
   {:app-name "Mayachok"
    ...
    :survey-birth-6m+ "6+ months"
    :open-source "This is an open source project."
    :region-question "Wo befinden Sie sich?"
    :region-title "Helfen Sie uns zu verstehen, wo Mütter Unterstützung brauchen"
    :region-hint "Ihre Region wird anonym gespeichert. Dies hilft, Ressourcen dorthin zu lenken, wo sie am meisten benötigt werden."
    :region-select-country "Land auswählen"
    :region-select-region "Region auswählen"
    :region-submit "Absenden"
    :region-skip "Überspringen"
   ...
   {:app-name "Маячок"
    ...
    :region-question "Де ви знаходитесь?"
    :region-title "Допоможіть нам зрозуміти, де мамам потрібна підтримка"
    :region-hint "Ваш регіон буде збережено анонімно. Це допоможе направити ресурси туди, де вони потрібні найбільше."
    :region-select-country "Оберіть країну"
    :region-select-region "Оберіть регіон"
    :region-submit "Надіслати"
    :region-skip "Пропустити"
